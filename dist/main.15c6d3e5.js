...
var simplifyUrl = function simplifyUrl(url) {
  return url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); //删除/开头结尾内容
};

var render = function render(newChild, refChild) {
  $siteList.find('li:not(.last)').remove();
  hashMap.forEach(function (node, index) {
    var $li = $("<li xmlns=\"http://www.w3.org/1999/html\">\n      <div class=\"site\">\n        <div class=\"siteHead\">\n            <div class=\"logoWrapper\">\n                <div class=\"siteWrapper\">\n                    <img\n                      src=\"".concat(node.url, "/favicon.ico\"\n                      alt=\"\"\n                      class=\"logo\"\n                    />\n                    <span class=\"hidden\">").concat(node.logo, "</span>\n                </div>\n            \n            <p class=\"description\">").concat(node.logoType, "</p>\n            </div>\n        </div>\n        <div class=\"link\">").concat(simplifyUrl(node.url), "</div>\n        <div class=\"close\">\n            <svg class=\"icon\">\n                <use xlink:href=\"#icon-close\"></use>\n            </svg>\n        </div>\n    </div>\n  </li>")).insertBefore($lastLi, refChild);
...
//# sourceMappingURL=main.15c6d3e5.js.map